...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "cloudiotrav77-starter"
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/cloudio"
  #   chef.validation_client_name = "cloudio-validator"
  #   chef.validation_key_path = ".chef/cloudio-validator.pem"
  # end
end
